		...
		<div class="container-fluid">
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
							...
							<div class="container-fluid">
								...
								<div class="collapse navbar-collapse navbar-ex1-collapse">
									<ul class="nav navbar-nav">
										<li class="active"><a href="<?php echo site_url() ?>">Data Klub</a></li>
					...
					<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
							...
							<table class="table table-hover" id="example">
								...
								<tbody>
									...
									<tr>
										...
										<td>
										<a href="<?php echo site_url()?>/pemain/index/<?php echo $key['id'] ?>" class="btn btn-success">Data Pemain</a>
						...
						<a href="<?php echo site_url()?>/Club/addData" class="btn btn-warning"><span class="glyphicon glyphicon-plus"></span> Tambah Klub</a>
						</div>
					</div>
